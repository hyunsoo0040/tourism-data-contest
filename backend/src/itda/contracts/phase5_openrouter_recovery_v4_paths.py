"""Fixed filesystem coordinates for the disjoint r4/v4 recovery lane.
...
OPENROUTER_V4_SNAPSHOT_PATH = (
    REPOSITORY_ROOT / "backend/src/itda/providers/openrouter_ox_alpha_api_contract_v4.json"
)
...
OPENROUTER_V3_PUBLIC_PACKET_RELATIVE = (
    "artifacts/public/phase5/openrouter-recovery-v3-request.json"
)
OPENROUTER_V3_PUBLIC_PACKET_PATH = REPOSITORY_ROOT / OPENROUTER_V3_PUBLIC_PACKET_RELATIVE
...
OPENROUTER_V4_TERMINAL_RELATIVE = (
    "artifacts/reports/phase5/openrouter-recovery-v4-terminal.json"
)
OPENROUTER_V4_PUBLIC_REQUEST_PATH = REPOSITORY_ROOT / OPENROUTER_V4_PUBLIC_REQUEST_RELATIVE
OPENROUTER_V4_PROTECTED_ROOT = REPOSITORY_ROOT / OPENROUTER_V4_PROTECTED_ROOT_RELATIVE
OPENROUTER_V4_TERMINAL_OUTPUT = REPOSITORY_ROOT / OPENROUTER_V4_TERMINAL_RELATIVE
